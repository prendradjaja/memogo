declare module '@sabaki/shudan' {
  import type { ComponentClass, CSSProperties, HTMLAttributes } from 'react'
  ...
  export const Goban: ComponentClass<GobanProps>
  export const BoundedGoban: ComponentClass<GobanProps & {
    maxWidth?: number
    maxHeight?: number
